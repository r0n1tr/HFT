...
async def hft_top_test(dut):
    ...
    # hardware_outputs = [dut.o_reg_8.value, dut.o_reg_7.value, dut.o_reg_6.value, dut.o_reg_5.value, dut.o_reg_4.value, dut.o_reg_3.value, dut.o_reg_2.value, dut.o_reg_1.value, dut.o_reg_0.value]

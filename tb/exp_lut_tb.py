...
test_values = [0.0, 0.30349, 0.5, 1.0, 0.3, 0.123456, 0.99839, 0.48548, 0.826813]
...
async def neg_limit(dut):
    ...
    # Capture and convert the output
    # utput = convert_fixed_point_output(dut.exp_value.value)
    dut._log.info(f"Input: {test_value} => ExpValue: {0.367879}")
